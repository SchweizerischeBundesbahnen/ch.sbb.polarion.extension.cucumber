    ...
    installFetchMock([
      {
        ...
        json: {
          ...
          automaticModuleName: 'ch.sbb.polarion.extension.cucumber',
          bundleVersion: '5.1.2',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.cucumber.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'Cucumber', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response('<h1>Cucumber Extension for Polarion ALM</h1><p>Edit JSON attachments.</p>', { status: 200 }),
      },
    ]);
